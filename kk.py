...
openai = OpenAI(api_key="your key goes here")
MACHINE_SPEC = "Windows, Intel i7 11th Gen" 
compile_cmd = [
    "C:/mingw64/bin/g++.exe", "-O2", "-std=c++17", "-o", "optimized.exe", "optimized.cpp"
]
...
def execute_cpp(code):
    ...
    try:
        compile_cmd = [
            "g++", "-O2", "-std=c++17", "-o", "optimized.exe", "optimized.cpp"
        ]
